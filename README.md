...
## 🚀 Hosting Instructions (No-Code Method)

If you cannot run terminal commands, follow these steps to host your website for free on Vercel:

### 1. Upload Code to GitHub (In Browser)
1. Go to [GitHub.com](https://github.com) and log in.
2. Go to your repository: `https://github.com/shreyan-coder123/PriceNova.git`
3. Click the **"Add file"** button -> **"Upload files"**.
4. Drag and drop all the files from this folder into the browser.
...
4. Click **"Deploy"**. (Everything is pre-configured for Vercel).

## 🛠 Key Features
- **3+ Platform Comparisons**: Aggressive matching engine groups products from Amazon, Flipkart, Myntra, etc.
- **₹500 Pro Upgrade**: Users get 10 free searches, then must pay via UPI to **9849575920**.
